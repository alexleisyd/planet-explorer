...
- **Real numbers** — radius, day length, axial tilt, surface gravity and orbital distance for every body, and a scale panel that works the distances out in light, radio and airliner time.
...
- **Avionics-style cockpit HUD** — a system-map strip scaled by log distance, and a full-screen orbital plot where planets crawl along their orbits at speeds proportional to their real periods.
